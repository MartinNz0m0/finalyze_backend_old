...
def mpesa_msgreader(msg, file):
    ...
    for i in range(len(msg)):
        ...
        elif 'of airtime for' in msg[i]['body']:
...
def mpesa_csvwriter(file, msg ,user):
    ...
    if not data:
        ...
        with open(f'uploads/{file}', 'a') as csvfile: # TODO: add change file name and add date to database
            fieldnames = ['Receipt No', 'Completion Time', 'Details', 'Paid In', 'Withdrawn', 'Balance']
